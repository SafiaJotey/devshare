    ...
    <main className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-background">
      ...
      <section className="hidden lg:flex flex-col justify-between p-12 bg-foreground text-background relative overflow-hidden">
        ...
        <div className="relative z-10 text-sm text-background/40 font-mono">
          © {new Date().getFullYear()} Dev Share. Built for developers.
        </div>
      </section>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-[10px] uppercase tracking-[0.2em]">
              <span className="bg-background px-4 text-foreground/40 font-bold">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            {!isLogin && (
              <div className="space-y-2">
                <Label
                  htmlFor="name"
                  className="text-[10px] uppercase tracking-widest text-foreground/60"
                >
                  Full Name
                </Label>
              ...
              <div className="flex justify-between items-center">
                ...
                {isLogin && (
                  <Button
                    type="button"
                    variant="link"
                    className="px-0 h-auto text-[10px] font-bold text-primary"
                  >
                    Forgot Password?
                  </Button>
                )}
