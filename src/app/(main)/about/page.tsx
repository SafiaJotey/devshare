...
const About = () => {
  return (
    <div className="space-y-32 pb-20 overflow-hidden">
      {/* SECTION 1: HERO MANIFESTO (Existing with subtle tweaks) */}
      ...
      {/* SECTION 2: THE PILLARS (Bento Style - Existing) */}
      <Section
        tag="Our Pillars"
          ...
          <div className="p-8 rounded-3xl bg-primary text-primary-foreground md:col-span-2 shadow-xl shadow-primary/10">
            <div className="flex flex-col md:flex-row gap-8 items-center">
               <div className="text-center md:text-left">
                  <h3 className="text-3xl font-black mb-2 italic tracking-tighter">NO FLUFF.</h3>
    ...
    {/* SECTION 3: THE KNOWLEDGE STACK (Comprehensive & Professional) */}
<section className="container-box py-10">
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-10">
        {[
          { 
            ...
            desc: "Beyond UI—focusing on performance, accessibility, and state management." 
          },
          { 
    ...
    {/* Right Side: Creative Visual (The "Code Archive") */}
    <div className="order-1 lg:order-2 relative">
      {/* Decorative Blobs */}
      <div className="absolute -top-10 -right-10 w-64 h-64 bg-primary/10 rounded-full blur-3xl" />
      <div className="absolute -bottom-10 -left-10 w-64 h-64 bg-accent/10 rounded-full blur-3xl" />
      
      <div className="relative glass-card rounded-[2.5rem] border border-foreground/10 overflow-hidden shadow-2xl">
        {/* Terminal Header */}
        ...
        {/* Visual Content: Topic Tags & Indicators */}
        <div className="p-8 space-y-8 font-mono">
            ...
            {/* A "Snippet" card floating inside */}
            <div className="mt-4 bg-primary/5 rounded-xl p-4 border border-primary/20 rotate-1 group-hover:rotate-0 transition-transform duration-500">
      ...
      {/* NEW SECTION 4: THE FLYWHEEL (Creative) */}
